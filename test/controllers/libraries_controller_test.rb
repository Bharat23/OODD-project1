...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { borrow_duration: @library.borrow_duration, fine_per_day: @library.fine_per_day, location: @library.location, name: @library.name } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { borrow_duration: @library.borrow_duration, fine_per_day: @library.fine_per_day, location: @library.location, name: @library.name } }
